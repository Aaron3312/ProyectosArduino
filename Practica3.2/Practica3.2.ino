...
#define DATABASE_URL "https://console.firebase.google.com/u/1/project/iot-robotarm/database/iot-robotarm-default-rtdb/data/~2F" //<databaseName>.firebaseio.com or <databaseName>.<region>.firebasedatabase.app
